...
import { ExtractTypeFromReferenceExpression, SimpleReferenceExpression, ReferenceExpression, StringReference } from '../parser/reference-parser.js';
 ...
 * ```
 */
export declare class FunctionModule<DB, TB extends keyof DB> {
    constructor();
    /**
