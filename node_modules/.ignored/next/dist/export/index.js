...
async function exportApp(dir, options, span) {
    ...
    return nextExportSpan.traceAsyncFn(async ()=>{
        ...
        if (options.isInvokedFromCli) {
            if (nextConfig.output === "export") {
                Log.warn('"next export" is no longer needed when "output: export" is configured in next.config.js');
                return;
            } else {
                Log.warn('"next export" is deprecated in favor of "output: export" in next.config.js https://nextjs.org/docs/advanced-features/static-html-export');
            }
        }
  ...
  Read more: https://nextjs.org/docs/messages/export-image-api`);
        ...
        if (options.buildExport && hasAppDir) {
            ...
            renderOpts.clientReferenceManifest = require((0, _path).join(distDir, _constants1.SERVER_DIRECTORY, _constants1.CLIENT_REFERENCE_MANIFEST + ".json"));
            // @ts-expect-error untyped
            ...
            // @ts-expect-error untyped
            renderOpts.serverActionsManifest = require((0, _path).join(distDir, _constants1.SERVER_DIRECTORY, _constants1.SERVER_REFERENCE_MANIFEST + ".json"));
        }
