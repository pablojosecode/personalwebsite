...
class HotReloader {
    ...
    async start() {
        ...
        for (const config1 of this.activeConfigs){
            ...
            config1.entry = async (...args)=>{
                var ref;
                const outputPath = ((ref = this.multiCompiler) == null ? void 0 : ref.outputPath) || "";
    ...
    invalidate() {
        var ref, ref7;
        const outputPath = (ref = this.multiCompiler) == null ? void 0 : ref.outputPath;
        return outputPath && ((ref7 = (0, _onDemandEntryHandler).getInvalidator(outputPath)) == null ? void 0 : ref7.invalidate());
    }
    async stop() {
        await new Promise((resolve, reject)=>{
    ...
    async getCompilationErrors(page) {
        ...
        } else if ((ref10 = this.clientStats) == null ? void 0 : ref10.hasErrors()) {
            return getErrors(this.clientStats);
        } else if ((ref8 = this.serverStats) == null ? void 0 : ref8.hasErrors()) {
            return getErrors(this.serverStats);
        } else if ((ref9 = this.edgeServerStats) == null ? void 0 : ref9.hasErrors()) {
