...
var _readonlyHeaders = require("../app-render/readonly-headers");
var _readonlyRequestCookies = require("../app-render/readonly-request-cookies");
...
class RequestAsyncStorageWrapper {
    /**
        ...
        const store = {
            get headers () {
                if (!cachedHeadersInstance) {
                    cachedHeadersInstance = new _readonlyHeaders.ReadonlyHeaders(headersWithoutFlight(req.headers));
                }
                return cachedHeadersInstance;
            },
            get cookies () {
                if (!cachedCookiesInstance) {
                    cachedCookiesInstance = new _readonlyRequestCookies.ReadonlyRequestCookies({
                        headers: {
                            get: (key)=>{
                                if (key !== "cookie") {
