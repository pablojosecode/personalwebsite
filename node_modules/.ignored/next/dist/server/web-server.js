...
var _utils1 = require("../build/webpack/loaders/next-serverless-loader/utils");
            ...
            fn: async (req, res, _params, parsedUrl)=>{
                ...
                if (pathname !== this.serverOptions.webServerConfig.page) {
                    ...
                    if ((0, _utils).isDynamicRoute(pathname)) {
                        ...
                        pathname = (0, _utils1).interpolateDynamicPath(pathname, query, routeRegex);
                        (0, _utils1).normalizeVercelUrl(req, true, Object.keys(routeRegex.routeKeys), true, routeRegex);
                    }
                }
