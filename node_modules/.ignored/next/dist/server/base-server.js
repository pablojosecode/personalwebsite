...
var _i18NProvider = require("./future/helpers/i18n-provider");
var _sendResponse = require("./send-response");
var _routeKind = require("./future/route-kind");
var _responseHandlers = require("./future/helpers/response-handlers");
class Server {
    constructor(options){
        var ref, ref1, ref2;
        ...
        this.i18nProvider = ((ref = this.nextConfig.i18n) == null ? void 0 : ref.locales) ? new _i18NProvider.I18NProvider(this.nextConfig.i18n) : undefined;
    ...
    async handleRequest(req, res, parsedUrl) {
        return (0, _tracer).getTracer().trace(_constants1.BaseServerSpan.handleRequest, {
            ...
            return this.handleRequestImpl(req, res, parsedUrl).finally(()=>{
                return span == null ? void 0 : span.setAttributes({
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        try {
            ...
            const domainLocale = (ref = this.i18nProvider) == null ? void 0 : ref.detectDomainLocale((0, _getHostname).getHostname(parsedUrl, req.headers));
            ...
            if (this.minimalMode && typeof req.headers["x-matched-path"] === "string") {
                try {
                    ...
                    const options = {
                        i18n: (ref4 = this.i18nProvider) == null ? void 0 : ref4.analyze(matchedPath, {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const hasGetInitialProps = !!((ref11 = components.Component) == null ? void 0 : ref11.getInitialProps);
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref10 = components.Document) == null ? void 0 : ref10.getInitialProps) !== "function" || // The built-in `Document` component also supports dynamic HTML for concurrent mode.
                ...
                try {
                    ...
                    if (response) {
                        ...
                        if (isSSG && process.env.NEXT_RUNTIME !== "edge") {
                            ...
                            let revalidate = (ref = context.store) == null ? void 0 : ref.revalidate;
        ...
        const { revalidate: revalidate1 , value: cachedData  } = cacheEntry1;
        const revalidateOptions = typeof revalidate1 !== "undefined" && (!this.renderOpts.dev || hasServerProps && !isDataReq) ? {
    ...
    async renderToResponseImpl(ctx) {
        ...
        const options = {
            i18n: (ref = this.i18nProvider) == null ? void 0 : ref.analyze(pathname, {
                defaultLocale: undefined
            })
        };
        try {
    ...
    async render404(req, res, parsedUrl, setHeaders = true) {
        ...
        if (this.nextConfig.i18n) {
            (_query = query).__nextLocale || (_query.__nextLocale = this.nextConfig.i18n.defaultLocale);
            (_query1 = query).__nextDefaultLocale || (_query1.__nextDefaultLocale = this.nextConfig.i18n.defaultLocale);
        }
        res.statusCode = 404;
