...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, turboNextBuild = false) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            let appPaths;
            if (appDir) {
                appPaths = await nextBuildSpan.traceChild("collect-app-paths").traceAsyncFn(()=>recursiveReadDir(appDir, (absolutePath)=>{
            ...
            const hasApp404 = !!(mappedAppPages == null ? void 0 : mappedAppPages["/not-found"]);
            ...
            if (config.experimental.clientRouterFilter) {
                ...
                const clientRouterFilters = createClientRouterFilter(appPageKeys, config.experimental.clientRouterFilterRedirects ? nonInternalRedirects : []);
                                ...
                                if (pageType === "app" && originalAppPath) {
                                    ...
                                    if (isEdgeRuntime(pageRuntime)) {
                                        ...
                                        if (appConfig.revalidate !== 0 && !hasAction) {
                                            ...
                                            const hasGenerateStaticParams = !!((ref10 = workerResult.prerenderRoutes) == null ? void 0 : ref10.length);
            ...
            if (config.experimental.preCompiledNextServer) {
                ...
                await nextBuildSpan.traceChild("trace-next-server").traceAsyncFn(async ()=>{
                    ...
                    const root = ((ref = config.experimental) == null ? void 0 : (ref13 = ref.turbotrace) == null ? void 0 : ref13.contextDirectory) ?? outputFileTracingRoot;
            ...
            if (combinedPages.length > 0 || useStatic404 || useDefaultStatic500 || isAppDirEnabled) {
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                    ...
                    for (const page2 of staticPages1){
                        const serverBundle = getPagePath(page2, distDir, undefined, false);
                    ...
                    async function moveExportedAppNotFoundTo404() {
                        return staticGenerationSpan.traceChild("move-exported-app-not-found-").traceAsyncFn(async ()=>{
                            const orig = path.join(distDir, "server", "app", "not-found.html");
