...
export class AppRouteRouteHandler {
    constructor(nextConfigOutput = undefined, requestAsyncLocalStorageWrapper = new RequestAsyncStorageWrapper(), staticAsyncLocalStorageWrapper = new StaticGenerationAsyncStorageWrapper(), moduleLoader = new NodeModuleLoader()){
   ...
   */ async load(definition) {
    ...
    async execute({ params , definition  }, req, res, context) {
        ...
        const response = await this.requestAsyncLocalStorageWrapper.wrap(requestAsyncStorage, requestContext, ()=>this.staticAsyncLocalStorageWrapper.wrap(staticGenerationAsyncStorage, {
                ...
                const wrappedRequest = proxyRequest(req instanceof WebNextRequest ? req.request : wrapRequest(req), module);
