...
export function setHttpClientAndAgentOptions(config, silent = false) {
    var ref;
    if (isAboveNodejs16) {
        var ref1;
...
function assignDefaults(dir, userConfig, silent = false) {
    ...
    if (result.output === "export") {
        if (result.i18n) {
            throw new Error('Specified "i18n" cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');
        }
        if (result.rewrites) {
            throw new Error('Specified "rewrites" cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');
        }
        if (result.redirects) {
            throw new Error('Specified "redirects" cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');
        }
        if (result.headers) {
            throw new Error('Specified "headers" cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');
        }
    }
    ...
    if (((ref5 = result.experimental) == null ? void 0 : ref5.outputFileTracingRoot) && !isAbsolute(result.experimental.outputFileTracingRoot)) {
