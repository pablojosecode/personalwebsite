...
import { ACTION, NEXT_ROUTER_PREFETCH, NEXT_ROUTER_STATE_TREE, RSC } from "../../client/components/app-router-headers";
            ...
            return {
                Component: ()=>{
                    return /*#__PURE__*/ React.createElement(React.Fragment, null, isPage && isClientComponent && isStaticGeneration ? /*#__PURE__*/ React.createElement(StaticGenerationSearchParamsBailoutProvider, {
                        ...
                        Component: Component
                    }) : /*#__PURE__*/ React.createElement(Component, Object.assign({}, props)), (preloadedFontFiles == null ? void 0 : preloadedFontFiles.length) === 0 ? /*#__PURE__*/ React.createElement("link", {
            ...
            if (process.env.NEXT_RUNTIME !== "edge") {
                ...
                try {
                    ...
                    if (isFetchAction) {
                        var ref1;
                        res.statusCode = 500;
                        return new RenderResult(((ref1 = err) == null ? void 0 : ref1.message) ?? "Internal Server Error");
                    }
                    throw err;
                }
            } else {
