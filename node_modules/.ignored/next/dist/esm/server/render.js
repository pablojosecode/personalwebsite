...
import { streamFromArray, streamToString, chainStreams, createBufferedTransformStream, renderToInitialStream, continueFromInitialStream } from "./node-web-streams-helper";
...
export async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    if (isSSG && !isFallback) {
        ...
        renderResultMeta.pageData = props1;
    ...
    if (isDataReq && !isSSG || renderResultMeta.isRedirect) {
        return new RenderResult(JSON.stringify(props1), renderResultMeta);
    }
