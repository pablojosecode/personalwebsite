...
export default class NextNodeServer extends BaseServer {
     ...
     */ if (this.renderOpts.optimizeFonts) {
        ...
        if (!options.dev && this.nextConfig.experimental.instrumentationHook) {
            try {
                const instrumentationHook = require(join(options.dir || ".", options.conf.distDir, "server", INSTRUMENTATION_HOOK_FILENAME));
    ...
    getRoutes() {
        ...
        if (this.hasAppDir) {
            routes.handlers.set(RouteKind.APP_ROUTE, new AppRouteRouteHandler(nextConfigOutput));
        }
        return routes;
    }
    ...
    generateRoutes() {
            ...
            ...this.generateFsStaticRoutes(),
            {
                ...
                fn: async (req, res, params, _parsedUrl)=>{
                    ...
                    if (this.nextConfig.i18n) {
                        ...
                        const domainLocale = (ref = this.i18nProvider) == null ? void 0 : ref.detectDomainLocale(hostname);
                        const localePathResult = (ref1 = this.i18nProvider) == null ? void 0 : ref1.analyze(pathname, {
                            defaultLocale: undefined
                        });
                        let detectedLocale = "";
                        if (localePathResult == null ? void 0 : localePathResult.detectedLocale) {
        ...
        const catchAllRoute = {
            ...
            fn: async (req, res, _params, parsedUrl)=>{
                ...
                if ((ref2 = options.i18n) == null ? void 0 : ref2.detectedLocale) {
