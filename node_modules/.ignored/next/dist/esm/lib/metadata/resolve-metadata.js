...
async function collectStaticImagesFiles(metadata, type) {
    ...
    const iconPromises = metadata[type].map(async (iconResolver)=>interopDefault(await iconResolver()));
...
export async function collectMetadata({ loaderTree , props , array , route  }) {
