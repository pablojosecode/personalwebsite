...
async function collectStaticImagesFiles(metadata, type) {
    ...
    const iconPromises = metadata[type].map(async (iconResolver)=>(0, _interopDefault).interopDefault(await iconResolver()));
...
async function collectMetadata({ loaderTree , props , array , route  }) {
