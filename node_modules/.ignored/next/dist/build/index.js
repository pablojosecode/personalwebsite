    ...
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (config.experimental.clientRouterFilter) {
                ...
                const clientRouterFilters = (0, _createClientRouterFilter).createClientRouterFilter(appPageKeys, config.experimental.clientRouterFilterRedirects ? nonInternalRedirects : []);
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                    ...
                    async function moveExportedAppNotFoundTo404() {
                        return staticGenerationSpan.traceChild("move-exported-app-not-found-").traceAsyncFn(async ()=>{
                            const orig = _path.default.join(distDir, "server", "app", "not-found.html");
