...
async function transformSource(source, sourceMap) {
    ...
    // A client boundary.
    if (isESM && ((ref2 = buildInfo.rsc) == null ? void 0 : ref2.type) === _constants1.RSC_MODULE_TYPES.client) {
        var ref4;
    ...
    if (((ref3 = buildInfo.rsc) == null ? void 0 : ref3.type) !== _constants1.RSC_MODULE_TYPES.client) {
...
const moduleProxy = "next/dist/build/webpack/loaders/next-flight-loader/module-proxy";
