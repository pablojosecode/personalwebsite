...
exports.getRSCModuleInformation = getRSCModuleInformation;
exports.getMiddlewareMatchers = getMiddlewareMatchers;
...
function getRSCModuleInformation(source, isServerLayer = true) {
    ...
    const actions = (ref = source.match(ACTION_MODULE_LABEL)) == null ? void 0 : (ref1 = ref[1]) == null ? void 0 : ref1.split(",");
    if (!isServerLayer) {
        return {
    ...
    const clientRefs = (ref2 = source.match(CLIENT_MODULE_LABEL)) == null ? void 0 : (ref3 = ref2[1]) == null ? void 0 : ref3.split(",");
    ...
    if (Array.isArray(swcAST == null ? void 0 : swcAST.body)) {
        try {
            ...
            for (const node of swcAST.body){
                var ref11, ref4, ref5, ref6;
                if (node.type === "ExportDeclaration" && ((ref11 = node.declaration) == null ? void 0 : ref11.type) === "VariableDeclaration") {
                    var ref7;
                    for (const declaration of (ref7 = node.declaration) == null ? void 0 : ref7.declarations){
                        if (declaration.id.value === "runtime") {
                            runtime = declaration.init.value;
                        }
                    }
                }
                if (node.type === "ExportDeclaration" && ((ref4 = node.declaration) == null ? void 0 : ref4.type) === "FunctionDeclaration" && [
                    "getStaticProps",
                    "getServerSideProps"
                ].includes((ref5 = node.declaration.identifier) == null ? void 0 : ref5.value)) {
                    ssg = node.declaration.identifier.value === "getStaticProps";
                    ssr = node.declaration.identifier.value === "getServerSideProps";
                }
                if (node.type === "ExportDeclaration" && ((ref6 = node.declaration) == null ? void 0 : ref6.type) === "VariableDeclaration") {
                    var ref8, ref9;
