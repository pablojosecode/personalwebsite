...
async function webpackBuildWithWorker() {
    ...
    const getWorker = (compilerName)=>{
        var ref;
        const _worker = new _jestWorker.Worker(__filename, {
            exposedMethods: [
                "workerMain"
            ],
            numWorkers: 1,
    ...
    for (const compilerName1 of ORDERED_COMPILER_NAMES){
        ...
        prunedBuildContext.serializedPagesManifestEntries = {
            edgeServerAppPaths: (ref7 = curResult.serializedPagesManifestEntries) == null ? void 0 : ref7.edgeServerAppPaths,
            edgeServerPages: (ref3 = curResult.serializedPagesManifestEntries) == null ? void 0 : ref3.edgeServerPages,
            nodeServerAppPaths: (ref4 = curResult.serializedPagesManifestEntries) == null ? void 0 : ref4.nodeServerAppPaths,
            nodeServerPages: (ref5 = curResult.serializedPagesManifestEntries) == null ? void 0 : ref5.nodeServerPages
        };
        combinedResult.duration += curResult.duration;
        if ((ref6 = curResult.turbotraceContext) == null ? void 0 : ref6.entriesTrace) {
