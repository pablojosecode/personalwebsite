...
exports.getEdgePolyfilledModules = getEdgePolyfilledModules;
exports.handleWebpackExternalForEdgeRuntime = handleWebpackExternalForEdgeRuntime;
exports.SUPPORTED_NATIVE_MODULES = exports.default = void 0;
...
function getCreateAssets(params) {
    ...
    return (assets)=>{
        ...
        for (const entrypoint of compilation.entrypoints.values()){
            ...
            const matcherSource = ((ref3 = metadata.edgeSSR) == null ? void 0 : ref3.isAppDir) ? (0, _appPaths).normalizeAppPath(page) : page;
...
function getExtractMetadata(params) {
    ...
    return async ()=>{
         ...
         */ if (!dev) {
                    ...
                    const hasOGImageGeneration = resource && /[\\/]node_modules[\\/]@vercel[\\/]og[\\/]dist[\\/]index\.(edge|node)\.js$/.test(resource);
...
exports.SUPPORTED_NATIVE_MODULES = SUPPORTED_NATIVE_MODULES;
