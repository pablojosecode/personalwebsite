                ...
                if (_nextData || getStaticProps || getServerSideProps) {
                    if (renderResultMeta.isNotFound) {
                        ...
                        (0, _sendPayload).sendRenderResult({
                            req,
                            res,
                            result: result2.isNull() ? _renderResult.default.empty : result2,
                            type: "html",
                            generateEtags,
                            poweredByHeader,
                            options: {
                        ...
                        const redirect = {
                            ...
                            statusCode: renderResultMeta.pageData.pageProps.__N_REDIRECT_STATUS,
                        ...
                        (0, _sendPayload).sendRenderResult({
                            req,
                            res,
                            result: _nextData ? _renderResult.default.fromStatic(JSON.stringify(renderResultMeta.pageData)) : result.isNull() ? _renderResult.default.empty : result,
