...
var _staticGenerationAsyncStorageWrapper = require("../server/async-storage/static-generation-async-storage-wrapper");
var _incrementalCache = require("../server/lib/incremental-cache");
var _patchFetch = require("../server/lib/patch-fetch");
var _nodeFsMethods = require("../server/lib/node-fs-methods");
...
async function buildAppStaticPaths({ page , distDir , configFileName , generateParams , isrFlushToDisk , incrementalCacheHandlerPath , requestHeaders , maxMemoryCacheSize , fetchCacheKeyPrefix , staticGenerationAsyncStorage , serverHooks  }) {
    ...
    const wrapper = new _staticGenerationAsyncStorageWrapper.StaticGenerationAsyncStorageWrapper();
    return wrapper.wrap(staticGenerationAsyncStorage, {
        pathname: page,
        renderOpts: {
            incrementalCache,
...
async function isPageStatic({ page , distDir , configFileName , runtimeEnvConfig , httpAgentOptions , enableUndici , locales , defaultLocale , parentId , pageRuntime , edgeInfo , pageType , hasServerComponents , originalAppPath , isrFlushToDisk , maxMemoryCacheSize , incrementalCacheHandlerPath , nextConfigOutput  }) {
        ...
        if (pageType === "app") {
            ...
            if (nextConfigOutput === "export") {
                if (!appConfig.dynamic || appConfig.dynamic === "auto") {
                    ...
                    throw new Error(`export const dynamic = "force-dynamic" on page "${page}" cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export`);
                }
            }
