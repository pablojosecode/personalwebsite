...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    if (isDataReq && !isSSG || renderResultMeta.isRedirect) {
        return new _renderResult.default(JSON.stringify(props1), renderResultMeta);
    }
    ...
    const renderDocument = async ()=>{
        ...
        const documentElement = (htmlProps)=>{
            if (process.env.NEXT_RUNTIME === "edge") {
                ...
                return /*#__PURE__*/ _react.default.createElement(Document, Object.assign({}, htmlProps, docProps1));
            }
        };
        let styles;
        if (hasDocumentGetInitialProps) {
