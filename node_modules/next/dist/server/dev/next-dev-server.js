        ...
        return new Promise(async (resolve, reject)=>{
           ...
           */ if (/[\\\\/]_middleware$/.test(pageName)) {
                ...
                if (this.nextConfig.experimental.clientRouterFilter) {
                    clientRouterFilters = (0, _createClientRouterFilter).createClientRouterFilter(Object.keys(appPaths), this.nextConfig.experimental.clientRouterFilterRedirects ? (this.nextConfig._originalRedirects || []).filter((r)=>!r.internal) : []);
