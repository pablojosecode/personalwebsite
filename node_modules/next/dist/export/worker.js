            ...
            if (isAppDir) {
                ...
                if (isRouteHandler) {
                    ...
                    try {
                        ...
                        const response = await handler.handle(match, nodeReq, nodeRes, staticContext);
                    ...
                    try {
                        ...
                        const result = await renderToHTMLOrFlight(req, res, isNotFoundPage ? "/404" : page, query, curRenderOpts);
