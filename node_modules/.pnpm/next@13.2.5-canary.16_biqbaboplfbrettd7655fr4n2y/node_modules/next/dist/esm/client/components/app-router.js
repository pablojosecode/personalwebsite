 ...
 */ function Router({ initialHead , initialTree , initialCanonicalUrl , children , assetPrefix  }) {
   ...
   */ const onPopState = useCallback(({ state  })=>{
    ...
    const content = /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(RedirectBoundary, null, cache.subTreeData, /*#__PURE__*/ React.createElement(AppRouterAnnouncer, {
        tree: tree
    })));
