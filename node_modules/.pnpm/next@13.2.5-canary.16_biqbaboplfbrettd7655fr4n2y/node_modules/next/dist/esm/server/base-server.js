...
export default class Server {
    constructor(options){
        ...
        this.i18nProvider = ((ref = this.nextConfig.i18n) == null ? void 0 : ref.locales) ? new I18NProvider(this.nextConfig.i18n) : undefined;
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        try {
            ...
            const domainLocale = (ref = this.i18nProvider) == null ? void 0 : ref.detectDomainLocale(getHostname(parsedUrl, req.headers));
