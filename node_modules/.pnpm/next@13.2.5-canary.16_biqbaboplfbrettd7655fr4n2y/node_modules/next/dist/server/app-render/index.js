...
var _defaultMetadata = require("../../lib/metadata/default-metadata");
...
async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts) {
    ...
    const { buildManifest , subresourceIntegrityManifest , serverActionsManifest , ComponentMod , dev , nextFontManifest , supportsDynamicHTML ,  } = renderOpts;
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const getDynamicParamFromSegment = (// [slug] / [[slug]] / [...slug]
        ...
        async function resolveHead({ tree , parentParams , metadataItems , treePrefix =[]  }) {
       ...
       */ const currentParams = // Handle null case where dynamic param is optional
            ...
            if (head) {
                ...
                const Head = await (0, _interopDefault).interopDefault(await head[0]());
                return [
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: tree , parentParams , firstItem , rootLayoutIncluded , injectedCSS , injectedFontPreloadTags , asNotFound  })=>{
            ...
            return {
                Component: ()=>{
                    return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, isPage && isClientComponent && isStaticGeneration ? /*#__PURE__*/ _react.default.createElement(StaticGenerationSearchParamsBailoutProvider, {
                        ...
                        Component: Component
                    }) : /*#__PURE__*/ _react.default.createElement(Component, Object.assign({}, props)), (preloadedFontFiles == null ? void 0 : preloadedFontFiles.length) === 0 ? /*#__PURE__*/ _react.default.createElement("link", {
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound  })=>{
        ...
        const [initialHead, metadataItems1] = await resolveHead({
            tree: loaderTree,
            parentParams: {},
            metadataItems: []
        });
     ...
     */ const ServerComponentsRenderer = (0, _createServerComponentsRenderer).createServerComponentRenderer(async (props)=>{
        ...
        const bodyResult = (0, _tracer).getTracer().wrap(_constants.AppRenderSpan.getBodyResult, {
            ...
            const getServerInsertedHTML = ()=>{
                ...
                // flushed.
                const errorMetaTags = [
                    ..._defaultMetadata.DEFAULT_METADATA_TAGS
                ];
        ...
        const isFormAction = req.method === "POST" && req.headers["content-type"] === "application/x-www-form-urlencoded";
            ...
            if (process.env.NEXT_RUNTIME !== "edge") {
                ...
                try {
                    const result = new _actionRenderResult.ActionRenderResult(JSON.stringify([
                        await actionHandler(actionId, bound)
                    ]));
                    ...
                    if (isFetchAction) {
                        var ref1;
                        res.statusCode = 500;
                        return new _renderResult.default(((ref1 = err) == null ? void 0 : ref1.message) ?? "Internal Server Error");
                    }
                    throw err;
                }
            } else {
