...
class NextTracerImpl {
   ...
   */ getTracerInstance() {
    ...
    trace(...args) {
        ...
        if (!_constants.NextVanillaSpanAllowlist.includes(type) && process.env.NEXT_OTEL_VERBOSE !== "1") {
            return fn();
        }
        ...
        const runWithContext = (actualFn)=>spanContext ? this.getTracerInstance().startActiveSpan(spanName, options, spanContext, actualFn) : this.getTracerInstance().startActiveSpan(spanName, options, actualFn);
