 ...
 */ function Router({ initialHead , initialTree , initialCanonicalUrl , children , assetPrefix  }) {
   ...
   */ const onPopState = (0, _react).useCallback(({ state  })=>{
    ...
    const content = /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/ _react.default.createElement(_redirectBoundary.RedirectBoundary, null, cache.subTreeData, /*#__PURE__*/ _react.default.createElement(_appRouterAnnouncer.AppRouterAnnouncer, {
        tree: tree
    })));
