  ...
  return (
    <>
       In my spare time, I'm passionate about many creative pursuits, including guitar, piano, literature,
          and of course, coding. You might catch me some days busking at Fisherman's Wharf! <br /> I absolutely love the creation process of software engineering- having an idea in my head 
